...
export default function Page() {
  return (
    <>
      ...
      <main className="mx-auto mt-8 flex w-full max-w-160 flex-1 flex-col items-center px-7 text-center md:mt-12 md:mb-4 md:px-0">
        <h1 className="text-gray mb-3.5 text-2xl leading-snug md:text-5xl">
          We are launching{" "}
          <span className="text-very-dark-blue font-bold">soon!</span>
        </h1>
        <p className="text-xs md:text-xl">Subscribe and get notified</p>
        <SubscribeForm />
        <Image
          src={illustration}
